...
if __name__=="__main__":
    ...
    # di.build_plot_data("release_year", "date_added", 10, "Release Year and Date Added", labels=["Year Added", "Number of Movies"])
    ...
    # di.build_plot_data("director", "date_added", 10, "India movie frequency", labels=["Year added", "Number of Movies"], filter={"country":"Japan"})
    # di.build_plot_data("cast", "date_added", 10, "India movie frequency", labels=["Year added", "Number of Movies"], filter={"country":"Japan"})
    di.build_pie_data("rating", 5, filter={"country":"United States"})